...
// Tribal nations ?
	...
	function language($word, $lang) {
		$dictionary = [
			// Login
			"admin_login" => ["Login", "Inicio"],
			"username" => ["username", "usuario"],
			"password" => ["password", "contraseña"],
			"remember_me" => ["remember me", "guardar inicio"],
			"login" => ["Login", "Inicio"],
			"forgot_password" => ["forgot password?", "resetear contraseña"],
			...
			"departments" => ["Manage Departments", "Manejar Deparmentos"],
			"users" => ["Manage Users", "Manejar Usuarios"],
			"cities" => ["Manage Cities", "Manejar Cuidades"],
			"areas" => ["Manage Areas", "Manejar Cuidades"],
			"machine-types" => ["Manage Machine Types", "Manejar tipo de Maquinas"],
			"machines" => ["Manage Machines", "Manejar Maquinas"],
			"transfers" => ["Patient's Transfers", "Manejar Transferidos"],
			"phoneNumbers" => ["Phone Numbers", "Manejar Numeros"],
			"positionRoles" => ["Employee's Position Role", "Manejar Posiciones de Empleados"],
			"employees" => ["Manage Employees", "Manejar Empleados"],
			...
			"machines-esName" => ["Machine Spanish Name", "اسم الجهاز بالعربية"],
			...
			"patients-name" => ["Name", "الاسم الاول"],
			...
			"patient-edit" => ["Edit Patient", "تعديل بيانات المريض"],
			...
			// General
			"id" => ["Identification Number", "Número de identificación"],
		];
