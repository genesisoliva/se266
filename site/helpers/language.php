<?php
	...
	function language($word, $lang) {
		$dictionary = [
			...
			"employees-creationTime" => ["creationTime", ""],
			...
			"employees-civil_id" => ["Civil ID 12", "الرقم المدنى"],
			"employees-civil" => ["Civil ID", "الرقم المدنى"],
			...
			"department-fill-in-msg" => ["(+) Add in the DEPARMENT that the employee belongs to", "اضف القسم التابع له الموظف لجدول الاقسام"],
			...
			"employees-passport_number" => ["Passport Number 8-9", "رقم جواز السفر"],
			...
			"patients-id-#" => ["ID #", "الرقم المدنى"],
			"patients-passport_number" => ["Passport Number 12", "رقم جواز السفر"],
			"patients-passport_#" => ["Passport Number 8-9", "رقم جواز السفر"],
