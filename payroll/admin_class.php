...
Class Action 
{
	...
	function save_user(){
		...
		if(empty($id)){
			...
			$save = $this->db->query("UPDATE users set ".$data." where userid = ".$id);
		}
		if($save){
			return 1;
		}
	...
	function delete_user(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM users where userid = ".$id);
		if($delete)
			return 1;
		}
	}
	...
	function save_employee(){
		...
		if(empty($id)){
			...
			$save = $this->db->query("UPDATE employee set ".$data." where employeeid=".$id);
		}
		if($save)
			return 1;
	}
	function delete_employee(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM employee where employeeid = ".$id);
		if($delete)
			return 1;
	}
	function save_department(){
		...
		if(empty($id)){
			...
			$save = $this->db->query("UPDATE departments set ".$data." where departmentid =".$id);
		}
		if($save)
			return 1;
	}
	function delete_department(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM departments where departmentid = ".$id);
		if($delete)
			return 1;
	}
	function save_position(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO positions set ".$data);
		}else{
			$save = $this->db->query("UPDATE positions set ".$data." where positionid =".$id);
		}
		if($save)
			return 1;
	}
	function delete_position(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM positions where positionid = ".$id);
		if($delete)
			return 1;
	}
	function save_allowances(){
		...
		if(empty($id)){
			...
			$save = $this->db->query("UPDATE allowances set ".$data." where allowanceid=".$id);
		}
		if($save)
			return 1;
	}
	function delete_allowances(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM allowances where allowanceid = ".$id);
		if($delete)
			return 1;
	}
	...
	function save_deductions(){
		...
		if(empty($id)){
			...
			$save = $this->db->query("UPDATE deductions set ".$data." where deductionid=".$id);
		}
		if($save)
			return 1;
	}
	function delete_deductions(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM deductions where deductionid = ".$id);
		if($delete)
			return 1;
	}
