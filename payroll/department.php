					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$department = $conn->query("SELECT * FROM departments order by departmentid asc");
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_department" type="button" data-id="<?php echo $row['departmentid'] ?>" data-name="<?php echo $row['name'] ?>"  >Edit</button>
										<button class="btn btn-sm btn-danger delete_department" type="button" data-id="<?php echo $row['departmentid'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
