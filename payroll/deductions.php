					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$deductions = $conn->query("SELECT * FROM deductions order by deductionid asc");
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_deductions" type="button" data-id="<?php echo $row['deductionid'] ?>" data-deduction="<?php echo $row['deduction'] ?>" data-description="<?php echo $row['description'] ?>" >Edit</button>
										<button class="btn btn-sm btn-danger delete_deductions" type="button" data-id="<?php echo $row['deductionid'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
