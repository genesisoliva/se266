					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$position = $conn->query("SELECT * FROM positions order by positionid asc");
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_position" type="button" data-id="<?php echo $row['positionid'] ?>" data-name="<?php echo $row['name'] ?>" data-department_id="<?php echo $row['department_id'] ?>"  >Edit</button>
										<button class="btn btn-sm btn-danger delete_position" type="button" data-id="<?php echo $row['positionid'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
