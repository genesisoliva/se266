					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$allowances = $conn->query("SELECT * FROM allowances order by allowanceid asc");
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_allowances" type="button" data-id="<?php echo $row['allowanceid'] ?>" data-allowance="<?php echo $row['allowance'] ?>" data-description="<?php echo $row['description'] ?>" >Edit</button>
										<button class="btn btn-sm btn-danger delete_allowances" type="button" data-id="<?php echo $row['allowanceid'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
