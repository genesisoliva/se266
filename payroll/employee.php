						...
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									...
									$dept = $conn->query("SELECT * from departments order by name asc");
										while($row=$dept->fetch_assoc()):
											$d_arr[$row['departmentid']] = $row['name'];
										endwhile;

									$pos = $conn->query("SELECT * from positions order by name asc");
										while($row=$pos->fetch_assoc()):
											$p_arr[$row['positionid']] = $row['name'];
										 endwhile;
								...
								<tr>
									...
									<td>
										<center>
										 <button class="btn btn-sm btn-outline-primary view_employee" data-id="<?php echo $row['employeeid']?>" type="button"><i class="fa fa-eye"></i></button>
										 <button class="btn btn-sm btn-outline-primary edit_employee" data-id="<?php echo $row['employeeid']?>" type="button"><i class="fa fa-edit"></i></button>
										<button class="btn btn-sm btn-outline-danger remove_employee" data-id="<?php echo $row['employeeid']?>" type="button"><i class="fa fa-trash"></i></button>
										</center>
									</td>
								</tr>
								<?php
