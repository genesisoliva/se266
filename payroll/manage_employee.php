...
<div class="container-fluid">
	<form id='employee_frm'>
		...
		<div class="form-group">
			...
			?>
				<option value="<?php echo $row['departmentid'] ?>" <?php echo isset($department_id) && $department_id == $row['departmentid'] ? "selected" :"" ?>><?php echo $row['name'] ?></option>
			<?php endwhile; ?>
			</select>
		</div>
		<div class="form-group">
			...
			?>
				<option class="opt" value="<?php echo $row['positionid'] ?>" data-did="<?php echo $row['department_id'] ?>" <?php echo isset($department_id) && $department_id == $row['department_id'] ? '' :"disabled" ?> <?php echo isset($position_id) && $position_id == $row['positionid'] ? " selected" : '' ?> ><?php echo $row['name'] ?></option>
			<?php endwhile; ?>
			</select>
		</div>
		<div class="form-group">
