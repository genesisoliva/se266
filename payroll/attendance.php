				...
				<div class="card">
					...
					<div class="card-body">
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									$att = $conn->query("SELECT a.*,e.employee_no, concat(e.lastname,', ',e.firstname,' ',e.middlename) as ename FROM attendance a inner join employees e on a.employee_id = e.employeeid order by UNIX_TIMESTAMP(datetime_log) asc  ") or die(mysqli_error());
								...
								<tr>
									...
									<?php 
									 ...
									 <div class="col-sm-6" style="">
										<p>
											<small><b><?php echo $lt_arr[$k].": </b>" ?>
											<?php echo (date("h:i A",strtotime($attendance[$key]['log'][$k]['date'])))  ?>
