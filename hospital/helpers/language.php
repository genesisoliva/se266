<?php
	...
	function language($word, $lang) {
		$dictionary = [
			// Login
			"login-content" => ["admin login1", "دخول المدير", "titulo1", ""],
			"login-title" => ["Login", "دخول المدير", "Iniciar", ""],
			"username" => ["username", "اسم المستخدم", "usuario", ""],
			"password" => ["password", "كلمة المرور", "constraseña", ""],
			"login-button" => ["login", "تسجيل الدخول", "iniciar", ""],
			"sign-up" => ["sign up","", "registrar", ""],
			"forgot_password" => ["forgot password?", "نسيت الباسورد؟", "resetear contraseña", ""],
			"remember_me" => ["remember me", ".......تذكرنى", "recordar", ""],
			"admin_login" => ["admin login", "دخول المدير", "titulo", ""],
			...
			"dashboard" => ["dashboard", "لوحة التحكم", "dashboard espanol"],
			"dashboardTitle" => ["DASHBOARD", "لوحة التحكم", "titulo"],
			"dropdown" => ["manage", "الادارة", 'manejar'],
			"logout" => ["logout", "تسجيل الخروج", "salir"],
			"genders" => ["manage genders", "إدارة النوع", 'manejar sexo'],
			"nationalities" => ["manage nationalities", "إدارة الجنسيات", "nacionalidades"],
			"natTypes" => ["manage nationality types", "إدارة انواع الجنسيات", 'manejar tipos de nacionlidades'],
			"departments" => ["manage departments", "إدارة الاقسام", "departmentos"],
			"users" => ["manage users", "إدارة المستخدمين", "usuarios"],
			"cities" => ["manage cities", "إدارة المدن", "cuidades"],
			"areas" => ["manage areas", "إدراة المناطق", "areas"],
			"machine-types" => ["manage machine types", "إدارة انواع الأجهزة", "tipos de maquinas"],
			"machines" => ["manage machines", "إدارة الأجهزة", "maquinas"],
			"transfers" => ["patient's transfers", "تحويلات المرضى", "transferidos"],
			"phoneNumb" => ["phone numbers", "ارقام التليفونات", "numeros"],
			"positionRoles" => ["employee's position role", "الوضع الوظيفى للموظف", "positionRoles"],
			"employees" => ["manage employees", "إدارة الموظفين", "empleados"],
			"patients" => ["manage patients", "إدارة المرضى", "pacientes"],
			"articles" => ["manage patient cases", "إدارة صحف الحالة", "articulos"],
			"disabilities" => ["manage disability cards", "إدارة بطاقات الإعانة", "disabilities"],
			"financials" => ["manage financial aids", "إدارة المساعدات المالية", "financials"],
			"receipts" => ["manage receipts", "إدارة استلام الاجهزة", "receipts"],

			// General
			"id" => ["Id", "الرقم المعرف"],

			// Genders
			"genders-heading" => ["manage genders", "إدارة النوع", "manejar sexos"],
			"genders-add" => ["add new gender", "إضافة نوع جديد", "agregar nuevo sexo"],
			"genders-gender" => ["gender", "النوع", "sexo"],
			"genders-manage" => ["manage gender", "إدارة النوع", "manejar sexo"],
			...
			"genders-edit" => ["edit gender", "تعديل النوع", "editar sexo", ""],
			...
			// Nationalities
			"nationalities-heading" => ["manage nationalities", "إدارة الجنسيات", "manejar nacionalidad"],
			"nationalities-nat" => ["nationality", "الجنسية", "nacionlidades"],
			"nationalities-manage" => ["manage mationality", "إدارة الجنسية", "manejar nacionalidades"],
			"nationalities-edit" => ["edit nationality", "تعديل الجنسية", "editar nacionalidades"],
			"nationalities-add" => ["add new nationality", "إضافة جنسية جديدة", "agregar una nacionalidad"],
			...
			// Nationality Types
			"nationalityTypes-heading" => ["manage nationality types", "إدارة انواع الجنسيات" ,"manejar tipos de naciondalidades"],
			"natType-type" => ["nationality type", "نوع الجنسية", "tipo de naciondalidad"],
			"natType-manage" => ["manage nationality type", "إدارة نوع الجنسية", "manejar naciondalidad"],
			"natType-edit" => ["edit nationality types", "تعديل نوع الجنسية", "agregar naciondalidad"],
			"natType-add" => ["add new nationality type", "إضافة نوع جنسية جديد", "agregar una nueva naciondalidad"],
			...
			// Departments
			"departments-heading" => ["manage departments", "إدارة الاقسام", "manejar departmentos"],
			"departments-dept" => ["department", "القسم", "departmento"],
			"departments-manage" => ["Manage Department", "إدارة القسم", "manejar departmento"],
			"departments-edit" => ["Edit Department", "تعديل القسم", "editar departmento"],
			"departments-add" => ["Add New Department", "إضافة قسم جديد", "agregar un nuevo departmento"],
			"departments-check-error" => ["ERROR: DEPARTMENT MUST BE FROM 1 TO 100 CHARACTERS LONG", "خطأ: القسم يجب ان يكون من حرف إلى 100 حرف", "ERROR: EL DEPARTAMENTO DEBE TENER DE 1 A 100 CARACTERES DE LARGO"],
			"departments-add-success" => ["DEPARTMENT HAS BEEN ADDED SUCCESSFULLY", "تم إضافة القسم بنجاح", "EL DEPARTAMENTO SE HA AÑADIDO CON ÉXITO"],
			...
			// Cities
			"cities-heading" => ["manage cities", "إدارة المدن", "manejar cuidades"],
			"cities-city" => ["city", "المدينة", "cuidad"],
			"cities-manage" => ["manage city", "إدارة المدينة", "manejar cuidad"],
			"cities-edit" => ["edit city", "تعديل المدينة", "editar cuidad"],
			"cities-add" => ["add new city", "إضافة مدينة جديدة", "agregar cuidad"],
			...
			// Areas
			"areas-heading" => ["Manage Areas", "إدارة المناطق", "manejar areas"],
			"areas-area" => ["Area", "المنطقة", "areas"],
			"areas-city" => ["City", "المدينة", "cuidad"],
			"areas-manage" => ["Manage Area", "إدارة المنطقة", "manejar cuidad"],
			"areas-edit" => ["Edit Area", "تعديل المنطقة", "editar cuidad"],
			"areas-add" => ["Add New Area", "إضافة منطقة جديدة", "agregar nueva cuidad"],
			...
			// Machine Types
			"machine-types-heading" => ["Manage Machine Types", "إدارة انواع الأجهزة", "manejar tipo de maquinas"],
			"machine-types-type" => ["Machine Type", "نوع الجهاز", "tipo de maquina"],
			"machine-types-manage" => ["Manage Machine Type", "إدارة نوع الجهاز", "manejar tipo de maquina"],
			"machine-types-edit" => ["Edit Machine Type", "تعديل نوع الجهاز", "editar tipo de maquina"],
			"machine-types-add" => ["Add New Machine Type", "إضافة نوع جهاز جديد", "Agregar una nueva tipo maquina"],
			...
			// Machines
			"machines-heading" => ["Manage Machines", "إدارة الأجهزة", "manejar maquinas"],
			"machines-arName" => ["Machine Arabic Name", "اسم الجهاز بالعربية", ""],
			"machines-enName" => ["Machine English Name", "اسم الجهاز بالإنجليزية", ""],
			"machines-description" => ["Machine Description", "وصف الجهاز", "descripcion"],
			"machines-type" => ["Machine Type", "نوع الجهاز", "tipo de maquina"],
			"machines-manage" => ["Manage Machine", "إدارة الجهاز", "manejar maquina"],
			"machines-edit" => ["Edit Machine", "تعديل الجهاز"],
			"machines-add" => ["Add New Machine", "إضافة جهاز جديد", "agregar nueva maquina"],
			...
			// Transfers
			"transfers-heading" => ["Manage Patient's Transfers", "إدارة تحويلات المرضى", "manejar tranferidos de pacientes"],
			"transfers-name" => ["Transfered From", "محول من", "transferido de"],
			"transfers-manage" => ["Manage Transfer", "إدارة التحويل", "manejar trasnferido"],
			"transfers-edit" => ["Edit Transfer", "تعديل التحويل"],
			"transfers-add" => ["Add New Transfer", "إضافة تحويل جديد", "agregar nuevo transferido"],
			...
			"receipts-edit" => ["Edit Machine Delivery", "تعديل إيصال استلام الجهاز", "editar Entrega de la máquina"],
			"receipts-add" => ["Add Machine Delivery", "إضافة إيصال استلام لجهاز", "Agregar entrega de máquina"],
			...
			"receipts-add-success" => ["Machine delivery has been added successfully", "تم إضافة إيصال الإستلام بنجاح", "La entrega de la máquina se ha agregado con éxito"],
			"receipts-required" => ["ERROR: PLEASE FILL IN THE REQUIRED FIELDS", "خطأ: من فضلك إملأ الخانات المطلوبة", ""],
			"receipts-update-success" => ["Machine delivery has been updated successfully", "تم تحديث إيصال الإستلام بنجاح", "La entrega de la máquina se ha actualizado correctamente"],
			"receipts-delete-success" => ["Machine delivery has been deleted successfully", "تم حذف إيصال الإستلام بنجاح", "La entrega de la máquina se ha eliminado correctamente"],
			"machine-delivery" => ["Machines delivery", "إيصالات إستلام الاجهزة", "entrega de maquinas"],
			"noReceipts" => ["No machine delivery to show", "لا يوجد إيصالات إستلام اجهزة لعرضها", "No hay entrega de la máquina para mostrar"],

			// Form
			"add" => ["add", "إضافة", "agregar"],
			"edit" => ["edit", "تعديل", "editar"],
			"delete" => ["delete", "حذف", "borrar"],

			// Errors
			"method_not_allowed_error" => ["ERROR: METHOD NOT ALLOWED", "خطأ: الطلب غير مسموح به", "ERROR: MÉTODO NO PERMITIDO"],
			"id-required" => ["ERROR: YOU MUST PROVIDE AN ID", "خطأ: يجب تحديد الرقم المعرف فى الطلب", "ERROR: DEBE PROPORCIONAR UN ID"],
			"id-not-found" => ["ERROR: ID NOT FOUND", "خطأ: الرقم المعرف غير موجود", "ERROR: ID NO ENCONTRADA"],
			"page-not-found" => ["ERROR: PAGE NOT FOUND", "خطأ: الصفحة غير موجودة", "ERROR: PAGINA NO ENCONTRADA"],
			"created_at" => ["created at", "تاريخ إنشاء السجل", "creado en"],
			"updated_at" => ["last update", "تاريخ اخر تحديث", "última actualización"],
			"date-wrong-format-error" => ["ERROR: WRONG DATE FORMAT", "خطأ: صيغة التاريخ غير صحيحة", "ERROR: FORMATO DE FECHA INCORRECTO"],

			// General
			"id" => ["identification number", "الرقم المعرف", "número de identificación"],
		];
